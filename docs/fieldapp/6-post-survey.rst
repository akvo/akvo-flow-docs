...
--------------------
After data collection, you need to check if there is enough space available on your SD card for your next field visit. How to do this, see `Check SD card status <https://flow.readthedocs.org/en/latest/docs/fieldapp/6-post-survey.html#check-sd-card-status>`_ .     
