...
Read more about `Preparing your devices for FLOW <https://flow.readthedocs.org/en/latest/docs/fieldapp2.0/2-installing-app.html#preparing-the-phone>`_ and `Launching and setting up the Field Survey app <https://flow.readthedocs.org/en/latest/docs/fieldapp2.0/3-launching-app.html>`_.
