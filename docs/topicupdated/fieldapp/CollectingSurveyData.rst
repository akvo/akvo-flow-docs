...
- **Geo Questions**: Uses the device GPS chip to automatically fill in latitude, longitude and elevation. Click the **Check Geo Location** button to fill in these questions.

- **Photo and Video Questions**: Presents the option to take a photo or video to supplement your data. Click the **Take Photo** or **Take Video** buttons to use the phone camera. A green check mark appears beside the photo question to indicate that a photo has been taken. 
