...
Before you can start using the Field Survey app, these steps need to be taken:
	...
	2. **Android settings** - Modify the Androids settings to allow the installation of applications from other sources then the Android App Market (now Google Play). To do this, click on the Menu button and select 'Settings'. Select 'Applicatons', and enable 'Unknown Sources'.
