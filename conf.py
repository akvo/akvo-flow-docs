...
project = u'FLOW'
copyright = u'2012-2014, Akvo Foundation'
...
html_theme = 'flow_theme'
html_theme_path = ['.']

# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a list of options available for each theme, see the
# documentation.
html_theme_options = {"sidebarlinkcolor":"#bdd73c"}
...
texinfo_documents = [
  ('index', 'FLOW', u'FLOW Documentation',
   u'Akvo FLOW team', 'FLOW', 'One line description of project.',
   'Miscellaneous'),
]
...
pdf_documents = [
('index', u'FLOW', u'FLOW', u'Akvo FLOW team'),
]
